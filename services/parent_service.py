        ...
        try:
            with get_session() as session:
                ...
                parent_settings["student_notifications"][str(student.id)] = {
                    "test_completion": True,  # Общие уведомления о завершении тестов
                    "weekly_reports": False,
                    "monthly_reports": False,
                    "low_score_notifications": True,  # НОВОЕ: уведомления при низких результатах
                    "high_score_notifications": True,  # НОВОЕ: уведомления при высоких результатах
